    ...
    <section className="bg-white py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          <div className="from-ocean-50 group relative overflow-hidden rounded-2xl bg-gradient-to-br to-white p-8 shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl">
            <div className="bg-ocean-100 absolute right-0 top-0 -mr-16 -mt-16 h-32 w-32 rounded-full opacity-20 transition-opacity duration-300 group-hover:opacity-30" />
